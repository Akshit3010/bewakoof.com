        ...
        <div className={styles.parent}>
          ...
          <div className={styles.parent_right}>
            ...
            <div className={styles.product_price}>
              Rs. 499 <span className={styles.striked_off}>Rs. 1299</span>{" "}
            ...
            <div className={styles.product_accordion}>
              <div className={styles.accordion_header} onClick={handleOffer}>
                <div>
              ...
              {accordion.desc && (
                <div className={styles.accordion_desc}>
                  ...
                  <div>
                    Commodity -
                    <span className={styles.desc_commodity}>Men's T-Shirt</span>
                  </div>
              ...
              <div className={styles.accordion_header} onClick={handleReturn}>
                <div>
              ...
              {accordion.return && (
                <div className={styles.accordion_desc}>
                  <div>
                    Easy returns utp 15 days of delivery. Exchange available on
                    select pincodes.
                  </div>
                </div>
              )}

              <div className={styles.accordion_header} onClick={handleDelivery}>
                <div>
                  DELIVERY DETAILS
                  <span>{accordion.delivery ? <BiMinus /> : <BiPlus />}</span>
                </div>
              </div>
              {accordion.delivery && (
                <div className={styles.accordion_desc}>
